...
> **Ghi chú phân tách journal:** File này giữ baseline, kết quả và checklist được lập tới ngày 2026-06-02. Các kết quả chạy trong ngày 2026-06-04 và checklist còn mở sau các run đó nằm ở `deployment/docs/journal/[deploy]-2026-06-04.md`.
> Checklist bên dưới là snapshot tại thời điểm lập plan 2026-06-02; trạng thái cập nhật sau khi chạy tiếp đã được tick trong file 2026-06-04.
